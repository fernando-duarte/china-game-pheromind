...
│   └── dataset_DEFAULT_INTEGRATION_IMF.FAD_FM_5.0.0.csv  # IMF Fiscal Monitor tax revenue data
├── output/                   # Directory for all output files
│   ├── china_data_processed.csv  # Processed data in CSV format
│   ├── china_data_processed.md   # Processed data in markdown format
│   └── china_data_raw.md         # Raw data in markdown format
